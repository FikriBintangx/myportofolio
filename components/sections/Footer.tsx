export default function Footer() {
    return (
        <footer id="contact" className="bg-background border-t border-foreground/10 text-foreground py-20 px-6 md:px-20">
            ...
            <div className="mt-20 pt-10 border-t border-foreground/5 flex justify-between items-center text-xs text-gray-600 font-mono">
